  ...
  return (
    <li className="w-full h-56 md:h-96 bg-stone-900  relative overflow-hidden rounded-md mb-2 group">
      ...
      <Link to={`/journis/${id}`} className="h-full w-full">
        ...
        <div className="bg-stone-900/60 border-t-2 border-(--color-brand) w-full absolute px-6 bottom-0 left-0 text-gray-200 py-3 translate-y-15 group-hover:-translate-y-[0.4px] flex gap-2 font-semibold text-sm whitespace-nowrap">
